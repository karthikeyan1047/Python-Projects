...
base_folder = r"C:\Users\karthikeyans\Desktop\SOA Data"
...
def downloads_to_soa():
    ...
    for file_name in os.listdir(dwl_folder):
        ...
        if '.xlsx' in file_name:
            ...
            center, year = parts[0], parts[1]
            dest_file_path = os.path.join(base_folder, f"SOA - {year}", center, file_name)
